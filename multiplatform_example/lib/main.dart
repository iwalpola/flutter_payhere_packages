...
class _AppState extends State<App> {
  static final String dynamicIdName = kIsWeb ? "Order" : "Payment";
  @override
  void initState() {
    super.initState();
    // initPlatformState();
  ...
  void startOneTimePayment(BuildContext context) async {
    ...
    await PayHere.startPayment(paymentObject, (dynamicId) {
      print("One Time Payment Success. $dynamicIdName Id: $dynamicId");
      showAlert(context, "Payment Success!", "$dynamicIdName Id: $dynamicId");
    }, (error) {
  ...
  void startRecurringPayment(BuildContext context) async {
    ...
    await PayHere.startPayment(paymentObject, (dynamicId) {
      //payment_id for mobile, order_id for web
      print("Recurring Payment Success. $dynamicIdName Id: $dynamicId");
      showAlert(context, "Payment Success!", "$dynamicIdName Id: $dynamicId");
    }, (error) {
  ...
  void startTokenizationPayment(BuildContext context) async {
    ...
    await PayHere.startPayment(paymentObject, (dynamicId) {
      print("Tokenization Payment Success. $dynamicIdName Id: $dynamicId");
      showAlert(context, "Payment Success!", "$dynamicIdName Id: $dynamicId");
    }, (error) {
